...
PORTFOLIO_ID = "2026-08-20-rapid-independent-prospective-strategy-portfolio-v1"
DESIGN_PATH = (
    "docs/superpowers/specs/"
    "2026-08-20-nansen-rapid-parallel-strategy-v1.md"
)

CHAINS = ("ethereum", "solana", "base", "bnb")
PARTITIONS = ("DISCOVERY", "VALIDATION", "CONFIRMATION", "REPLICATION")
PARTITION_SALT = (
    b"2026-08-20-rapid-independent-prospective-strategy-portfolio-v1|identity-partition-v1"
)
PARTITION_SALT_SHA256 = (
    "7b1785558e04520c918d612a22f5e47841ff1e5dd56bb36294a5fa286621b2ba"
)

FIRST_CYCLE_AT = datetime(2026, 8, 22, 12, 5, tzinfo=timezone.utc)
DISCOVERY_CYCLES = 42
