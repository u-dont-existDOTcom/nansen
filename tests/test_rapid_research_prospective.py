...
from programs.nansen_rapid_research_v1 import aggregate
from programs.nansen_rapid_research_v1 import contract
from programs.nansen_rapid_research_v1 import design
from programs.nansen_rapid_research_v1 import timing
...
def test_schedule_purge_blocks_and_budget_are_exact():
    ...
    assert cycles[0].scheduled_at.isoformat() == "2026-08-22T12:05:00+00:00"
    assert cycles[41].scheduled_at.isoformat() == "2026-09-05T04:05:00+00:00"
    assert cycles[42].scheduled_at - cycles[41].scheduled_at == timedelta(hours=32)
    assert cycles[-1].scheduled_at.isoformat() == "2026-09-20T12:05:00+00:00"
...
def test_partition_hash_and_golden_vectors():
    ...
    vectors = {
        ...
        ("bnb", "0xabcdefabcdefabcdefabcdefabcdefabcdefabcd"): "DISCOVERY",
        ("solana", "EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v"): "VALIDATION",
...
def test_point_in_time_feature_payload_bounds_are_exact():
    ...
    assert flow["date"] == {
        ...
        "to": "2026-08-22T11:59:59.999999Z",
    }
    wbs = design.breadth_payload(candidate, cycle, "BUY", 1)
    assert wbs["date"] == {
        "from": "2026-08-21T12:05:00Z",
        "to": "2026-08-22T12:04:59.999999Z",
    }
...
def test_raw_counterfactual_replay_preserves_partial_round_trip():
    ...
    t0 = datetime(2026, 8, 22, 12, 20, tzinfo=timezone.utc)
...
def test_nonconstant_frozen_ten_thousand_bootstrap_golden_vector():
    ...
    ) == pytest.approx(-0.13333333333333336)
